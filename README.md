...
<li>User profiles include more information on the user (full name, email, phone, join date), their campgrounds, and the option to edit their<pre><code>profile or delete their account</code></pre></li>
